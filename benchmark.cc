...
#include "benchmarks/benchmark_hybrid_pgm_lipp.h" //Task 2
                    ...
                    const std::string& only, const std::string& /*filename*/) 
{
  ...
  check_only("HybridPGMLipp", benchmark_64_hybrid_pgm_lipp<SearchClass>(benchmark, pareto, params)); //Task 2
}
                    ...
                    const std::string& only, const std::string& filename)
{
  ...
  check_only("LIPP", benchmark_64_lipp(benchmark));
  check_only("HybridPGMLipp", benchmark_64_hybrid_pgm_lipp<record>(benchmark, filename)); //Task 2
}
